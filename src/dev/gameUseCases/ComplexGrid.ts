...
grid.addCard(2, 2, new Card('Circle', 3, 'Blue'));

// Create another vertical line (all same number 3, different shapes, different colors)
// Vertical line at x=2: Square 3 Red (from horizontal), Triangle 3 Blue, Circle 3 Blue (from horizontal), Plus 3 Green
grid.addCard(2, 1, new Card('Triangle', 3, 'Blue'));
grid.addCard(2, 3, new Card('Plus', 3, 'Green'));
...
export const complexGrid: UseCase = {
  name: 'Complex Grid',
  description: 'Multiple intersecting lines with different colors: horizontal lines at y=0 (Red) and y=2 (Blue), vertical lines at x=0 (mixed colors) and x=2 (all number 3, different shapes and colors). Cards can be part of multiple lines.',
  gameState,
};
